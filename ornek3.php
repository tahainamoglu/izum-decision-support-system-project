...
<body>
    ...
    <div class="chart-container">
        ...
        <div id="donutchart" style="width: 100%; height: 500px; margin-top: 20px;"></div>
    </div>
    ...
    <script>
        ...
        // Google Charts ile pizza grafiği oluşturun
        google.charts.setOnLoadCallback(drawPieChart);

        function drawPieChart() {
            var pieData = new google.visualization.DataTable();
            pieData.addColumn('string', 'Durum Adı');
            pieData.addColumn('number', 'Kaza Sayısı');

            // Veritabanından gelen verileri pizza grafiği için ekleyin
            <?php
            foreach ($data2 as $row2) {
                echo "pieData.addRow(['{$row2['durum_ad']}', {$row2['arac_mudahale']}]);";
            }
            ?>
